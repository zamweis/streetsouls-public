...
<head>
    <title>Street Souls - <?php echo json_decode(file_get_contents('text/navigation.json'))->terms->$lang; ?></title>
    <!-- meta information -->
    <meta charset="utf-8" />
...
<section class="wrapper grey-style">
    ...
    <div class="padding2rem white">
        <div class="padding2rem">
            <div class="padding2rem">
                <header>
                    <h2>Welcome to STREET SOULS asbl</h2>
                </header>
                <p>These terms and conditions outline the rules and regulations for the use of STREET SOULS asbl's
                    Website.</p>
                <header>
                    <h3>STREET SOULS asbl is located at</h3>
                </header>
                <p>9a rue de la Forêt , L-3317 Bergem, Luxembourg</p>
                <p>By accessing this website we assume you accept these terms and conditions in full. Do not
                    continue to
                    use STREET SOULS asbl's website if you do not accept all of the terms and conditions stated on
                    this
                    page.</p>
            </div>
            <div class="padding2rem">
                ...
                <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                    ...
                    All
                    terms refer to the offer, acceptance and consideration
                    of payment necessary to undertake the process of our assistance to the Client in the most
                    appropriate manner, whether by formal meetings of a fixed duration, or any other means, for the
                    ...
                    prevailing law of Luxembourg. Any use of the above terminology or other words in the singular,
            ...
            <div class="padding2rem">
                ...
                <p>We employ the use of cookies. By using STREET SOULS asbl's website you consent to the use of
                    cookies
                    in accordance with STREET SOULS asbl's privacy policy. Most of the modern day interactive web
                    sites
                    use cookies to enable us to retrieve user details
                    ...
                    use
                    cookies. License. Unless otherwise stated,
                    STREET SOULS asbl and/or it's licensors own the intellectual property rights for all material on
                    STREET SOULS asbl. All intellectual property rights are reserved. You may view and/or print
                    pages
                    from https://streetsouls.lu for your own personal
            ...
            <div class="padding2rem">
                ...
                <ul>
                    <li>Republish material from https://streetsouls.lu</li>
                    <li>Sell, rent or sub-license material from https://streetsouls.lu</li>
                    <li>Reproduce, duplicate or copy material from https://streetsouls.lu</li>
                    <li>Redistribute content from STREET SOULS asbl (unless content is specifically made for
                        redistribution).
                    </li>
                </ul>
            </div>
            <div class="padding2rem">
                ...
                <p>This Agreement shall begin on the date hereof. Certain parts of this website offer the
                    opportunity
                    for users to post and exchange opinions, information, material and data ('Comments') in areas of
                    the
                    website. STREET SOULS asbl does not screen,
                    edit, publish or review Comments prior to their appearance on the website and Comments do not
                    reflect the views or opinions of STREET SOULS asbl, its agents or affiliates. Comments reflect
                    the
                    view and opinion of the person who posts such view
                    or opinion. To the extent permitted by applicable laws STREET SOULS asbl shall not be
                    responsible or
                    liable for the Comments or for any loss cost, liability, damages or expenses caused and or
                    suffered
            ...
            <div class="padding2rem">
                ...
                <p>STREET SOULS asbl reserves the right to monitor all Comments and to remove any Comments which it
            ...
            <div class="padding2rem">
                ...
                <p>You hereby grant to STREET SOULS asbl a non-exclusive royalty-free license to use, reproduce,
                    edit
            ...
            <div class="padding2rem">
                ...
                <h3>The following organizations may link to our Web site without prior written approval:</h3>
                <ul>
                    ...
                    <li>charity fundraising groups which may not hyperlink to our Web site</li>
                </ul>
                <header>
                    <h3>These organizations may link to our home page, to publications or to other Web site
                        information
                        so long as the link:</h3>
                </header>
                <ul>
                ...
                <header>
                    <h3>We may consider and approve in our sole discretion other link requests from the following
                        types
                        of organizations:</h3>
                </header>
                <ul>
                ...
                <p>
                    ...
                    organizations representing inherently suspect types of
                    business, such as work-at-home opportunities, shall not be allowed to link); (b)the organization
                    does not have an unsatisfactory record with us; (c) the benefit to us from the visibility
                    associated
                    with the hyperlink outweighs the absence of ;
                ...
                <ul>
                    <li>is not in any way misleading;</li>
                    <li>does not falsely imply sponsorship, endorsement or approval of the linking party and it
                        products
                        or services; and
                    </li>
                ...
                <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to
                    our
                    website, you must notify us by sending an e-mail to info@streetsouls.lu. Please include your
                    name,
                    your organization name, contact information (such
                    as a phone number and/or e-mail address) as well as the URL of your site, a list of any URLs
                    from
                    which you intend to link to our Web site, and a list of the URL(s) on our site to which you
                    would
                    like to link. Allow 2-3 weeks for a response.</p>
                <header>
                ...
                <p>No use of STREET SOULS asbl's logo or other artwork will be allowed for linking absent a
                    trademark
                    license agreement.</p>
            </div>
            <div class="padding2rem">
            ...
            <div class="padding2rem">
                ...
                <p>We reserve the right at any time and in its sole discretion to request that you remove all links
                    ...
                    upon
                    such request. We also reserve the right to amend
                    these terms and conditions and its linking policy at any time. By continuing to link to our Web
            ...
            <div class="padding2rem">
                ...
                <p>If you find any link on our Web site or any linked web site objectionable for any reason, you may
                    ...
                    do
                    so or to respond directly to you. Whilst we endeavor
                    to ensure that the information on this website is correct, we do not warrant its completeness or
                    accuracy; nor do we commit to ensuring that the website remains available or that the material
                    on
            ...
            <div class="padding2rem">
                ...
                <p>We shall have no responsibility or liability for any content appearing on your Web site. You
                    ...
                    may
                    appear on any page on your Web site or within
                    any context containing content or materials that may be interpreted as libelous, obscene or
            ...
            <div class="padding2rem">
                ...
                <p>To the maximum extent permitted by applicable law, we exclude all representations, warranties and
                    ...
                    any
                    warranties implied by law in respect of satisfactory
                ...
                <p>The limitations and exclusions of liability set out in this Section and elsewhere in this
                    ...
                    disclaimer or in relation to the subject matter of
                    this disclaimer, including liabilities arising in contract, in tort (including negligence) and
                    for
                    breach of statutory duty. To the extent that the website and the information and services on the
                    website are provided free of charge, we will not

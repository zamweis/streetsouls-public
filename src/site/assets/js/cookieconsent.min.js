        ...
        t.fadeEnd = function () {
            ...
            t.Popup = function () {
                ...
                switch (lang) {
                    ...
                    case "de":
                        result = {
                            message: "Diese Website verwendet Cookies, um sicherzustelle…tmögliche Erfahrung auf unserer Website erzielen.",
                    ...
                    case "lb":
                        result = {
                            message: "Dës Websäit benotzt Cookien fir sécher ze sinn datt Dir déi bescht Erfahrung op eiser Websäit kritt.",
                            link: "Méi Informatioun",
                            href: "terms_and_conditions",
                            target: "_blank",
                            button: "Ech stëmmen zou!"
                        };
                        break;
                }
                var n = {
                    ...
                    template: '<span class="wpcc-message">{{message}} <br><a class="wpcc-privacy" href="{{href}}">{{link}}</a></span><div class="wpcc-compliance" ><a class="wpcc-btn" tabindex="2">{{button}}</a></div>',
                    pushdown: !1,
